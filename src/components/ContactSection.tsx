...
const contactInfo = [
  {
    ...
    color: "from-[#E84D3D] to-[#E84D3D]",
  },
  {
    icon: Phone,
    title: "Phone",
    content: "+91 9846606873",
    link: "tel:+919846606873",
...
const ContactSection = () => {
  ...
  const whatsappNumber = "919846606873"; // Replace with your WhatsApp number
      ...
      <div className="container mx-auto px-6 lg:px-12 relative">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
            Contact <span className="bg-gradient-to-r from-red-500 to-[#E84D3D] bg-clip-text text-transparent">Us</span>
          </h2>
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-2xl border border-slate-200 space-y-6 h-full">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  style={{
                    background: "linear-gradient(to right, #E84D3D, #E84D3D)",
                  }}
